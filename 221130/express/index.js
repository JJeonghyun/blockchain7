...
// app.use(cors()); // CORS 해결, 또 현재로는 단점이 있다(모든 주소에 대해서 응답해준다.)

app.use(cors({ origin: "http://localhost:3000" }));
// origin은 원본의 주소이며 해당 원본 주소에 대해서만 요청을 응답하겠다
//  - 원본 주소에서는 http와 같은 프로토콜, localhost와 같은 Domain 주소, :3000과 같은 포트까지 포함한다
...
// GET 에서는 발생하는 경우가 거의 없지만 POST등에서는 거의 대부분 발생한다
// 해결방법 : proxy 라는 개념을 사용한다
// Proxy : 중간 서버, 중간에서 다른 서버에 자료를 요청해서 자기 것인것  마냥 응답으로 보낸다 < 자세한 사항은 각자 알아서
