...
// 함수형 컴포넌트는 mount, update 시에 함수 자체를 다시 호출 한다.
...
// - useContext, useReducer도 있지만 해당 Hook은 Redux 내용과 같이
// useEffect, useCallback, useMemo의 경우 상황에 따라 필요없는 코드를 실행시키지 않도록 사용
function App() {
  console.log("app");
